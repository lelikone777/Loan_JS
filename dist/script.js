...
window.addEventListener('DOMContentLoaded', function () {
  ...
  slider.render();
  var modulePageSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
    container: '.moduleapp',
    btns: '.next'
  });
  modulePageSlider.render(); // showUpSlider
  ...
  new _modules_playVideo__WEBPACK_IMPORTED_MODULE_2__["default"]().init();
